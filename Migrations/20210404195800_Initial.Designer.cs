...
namespace BowlingLeague.Migrations
{
    ...
    [Migration("20210404195800_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BowlingLeague.Models.Bowler", b =>
                {
            ...
            modelBuilder.Entity("BowlingLeague.Models.BowlerScore", b =>
                {
            ...
            modelBuilder.Entity("BowlingLeague.Models.MatchGame", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("int")
                        .HasColumnName("MatchID");
            ...
            modelBuilder.Entity("BowlingLeague.Models.Team", b =>
                {
                    b.Property<long>("TeamId")
                        .HasColumnType("int")
                        .HasColumnName("TeamID");
            ...
            modelBuilder.Entity("BowlingLeague.Models.Tournament", b =>
                {
            ...
            modelBuilder.Entity("BowlingLeague.Models.TourneyMatch", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("int")
                        .HasColumnName("MatchID");
            ...
            modelBuilder.Entity("BowlingLeague.Models.ZtblBowlerRating", b =>
                {
            ...
            modelBuilder.Entity("BowlingLeague.Models.ZtblSkipLabel", b =>
                {
            ...
            modelBuilder.Entity("BowlingLeague.Models.ZtblWeek", b =>
                {
            ...
            modelBuilder.Entity("BowlingLeague.Models.Bowler", b =>
                {
                    b.HasOne("BowlingLeague.Models.Team", "Team")
                        .WithMany("Bowlers")
            ...
            modelBuilder.Entity("BowlingLeague.Models.BowlerScore", b =>
                {
                    b.HasOne("BowlingLeague.Models.Bowler", "Bowler")
            ...
            modelBuilder.Entity("BowlingLeague.Models.MatchGame", b =>
                {
                    b.HasOne("BowlingLeague.Models.TourneyMatch", "Match")
                        .WithMany("MatchGames")
            ...
            modelBuilder.Entity("BowlingLeague.Models.TourneyMatch", b =>
                {
                    b.HasOne("BowlingLeague.Models.Team", "EvenLaneTeam")
                        .WithMany("TourneyMatchEvenLaneTeams")
                        .HasForeignKey("EvenLaneTeamId");

                    b.HasOne("BowlingLeague.Models.Team", "OddLaneTeam")
                        .WithMany("TourneyMatchOddLaneTeams")
                        .HasForeignKey("OddLaneTeamId");

                    b.HasOne("BowlingLeague.Models.Tournament", "Tourney")
